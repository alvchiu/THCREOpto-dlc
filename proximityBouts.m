function proximityBouts(structname)
...
dlcmedstruct.Proximity.FoodCup.TotalInteractionsRaw = duration_storage;
dlcmedstruct.Proximity.FoodCup.TotalBouts = boutfinal;
dlcmedstruct.Proximity.FoodCup.DistanceTraceRaw = m;
dlcmedstruct.Proximity.FoodCup.ProximityTraceRaw = duration;
dlcmedstruct.Proximity.FoodCup.NumberofBouts = length(boutfinal);
dlcmedstruct.Proximity.FoodCup.Average = average;
dlcmedstruct.Proximity.FoodCup.LeverInteractions = leverInteractions;
dlcmedstruct.Proximity.FoodCup.TotalInteractionLever = leverTotalInteract;
